...
function loadScripts(googleId, metaId, zohoScriptURL, hotjarId, youtubeId, linkedinId, tiktokPixelId) {
    ...
    // Load YouTube script only if marketing consent is granted
    if (youtubeId && localStorage.getItem('ad_storage') === 'granted') {
    ...
    // Load LinkedIn script only if marketing consent is granted
    if (linkedinId && localStorage.getItem('ad_storage') === 'granted') {
